...
/* 1.1. Unión Externa : .............. UNION, UNION ALL                                  */
/* 1.1.1. UNION : .................... UNION                                             */
/* 1.1.2. UNION ALL : ................ UNION ALL                                         */
/* 1.2. Unión Interna : .............. INNER JOIN, LEFT JOIN, RIGHT JOIN                 */
/* 1.2.1. INNER JOIN : ............... INNER JOIN                                        */
/* 1.2.2. LEFT JOIN : ................ LEFT JOIN                                         */
/* 1.2.2. RIGHT JOIN : ............... RIGHT JOIN                                        */
/* 1.3. Subconsultas : ...............                                                   */
/* 2. CONSULTAS DE ACCIÓN                                                                */
/* 1.1. Crear una Tabla con otra : ... CREATE TABLE __ SELECT __ FROM __ WHERE __ = __   */
/* 1.2. Eliminar de Tabla Relación : .                                                   */
/* 1.3. Datos Anexados : ............. INSERT INTO __ SELECT __ FROM __                  */
/* ------------------------------------------------------------------------------------- */
/* ************************************************************************************* */
...
-- ------------------------------------------------------------------------------------- --
-- 1.1. Crear una Tabla a partir de otra Tabla. ---------------------------------------- --
...
-- ------------------------------------------------------------------------------------- --
-- 1.2. Eliminar Datos de una Tabla Relacionada. --------------------------------------- --
--       : -------------------------------------------- --
-- ------------------------------------------------------------------------------------- --
