...
CREATE TABLE IF NOT EXISTS `bbdd_ventas`.`CREDENCIALES_PEDIDOS` (
  `codigo_user` VARCHAR(10) NOT NULL,
  `codigo_pedido` VARCHAR(10) NOT NULL,
  INDEX `ind_credenciales_pedidos_credenciales` (`codigo_user` ASC) INVISIBLE,
  INDEX `ind_credenciales_pedidos_pedidos` (`codigo_pedido` ASC) INVISIBLE,
